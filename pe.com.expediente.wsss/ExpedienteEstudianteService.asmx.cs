...
{
    /// <summary>
    /// Descripción breve de ExpedienteEstudianteService
    /// </summary>
    ...
    public class ExpedienteEstudianteService : System.Web.Services.WebService
    {

        BALEstudiantes balestu = new BALEstudiantes();
        //BALCategorias balpro = new BALCategorias();
